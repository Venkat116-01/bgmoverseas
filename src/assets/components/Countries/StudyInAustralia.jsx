...
export default function StudyInAustralia() {
    ...
    <>
      ...
      >
        <div className="container text-center py-5">
          <h1 className="page-hero-title">Study in Australia</h1>
  ...
  <div className="mb-5">
    ...
    <p>
      ...
      international graduates, allowing them to gain valuable professional
      experience after completing their studies. These opportunities help
      students strengthen their careers and may provide pathways toward
